...
class Citation(BaseModel):
    ...
    doc_type: str = Field(description="Document type (e.g. statute, policy, case_study)")
...
class GeneratorOutput(BaseModel):
    ...
    answer: str = Field(description="Citation-grounded advisory text containing inline citation markers like [1], [2]")
    citations: list[Citation] = Field(description="Ordered list of source citations mapped to inline markers")
    abs_flag: bool = Field(description="Indicates whether Access and Benefit Sharing (ABS) compliance applies")
